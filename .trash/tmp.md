...
not accurate, because higher observation just means a higher statistical power/accurate estimate of the pearson correlation. it should not affect latent factor grouping
...
data format not needed to be in paper, put to github?
...
data scraping and formatting specifics could be skipped?
...
this section could be just 1 paragraph
