...
| S_all_standard     | onesidedmc      | 0.7554 |   0.365 | r=2 (swept 1..10)                  |
| C_all_aggressive   | softimpute      | 0.6739 |   0.337 | rank=5 (swept 1..10)               |
| C_all_standard     | onesidedmc      | 0.7261 |   0.321 | r=2 (swept 1..10)                  |
| C_all_standard     | softimpute_corr | 0.8126 |   0.317 | rank=5 (swept 1..7)                |
| S_all_standard     | knn             | 0.8104 |   0.296 | k=5 (swept 1..10)                  |
| R_all_standard     | softimpute      | 0.7245 |   0.290 | rank=4 (swept 1..10)               |
| C_all_standard     | knn             | 0.8232 |   0.288 | k=5 (swept 1..10)                  |
| C_all_standard     | fill-zeros           | 0.8910 |   0.286 | fill=zero                          |
| S_all_aggressive   | softimpute      | 0.7068 |   0.282 | rank=10 (swept 1..10)              |
| C_all_aggressive   | onesidedmc      | 0.8815 |   0.278 | r=2 (swept 1..10)                  |
| raw_all_standard   | softimpute      | 0.7401 |   0.249 | rank=9 (swept 1..10)               |
| C_all_aggressive   | missforest      | 0.8275 |   0.241 | ntree=50 (swept [50,100,200,400])  |
| raw_all_aggressive | softimpute      | 0.7457 |   0.228 | rank=10 (swept 1..10)              |
| C_all_standard     | fill-mean       | 0.9268 |   0.224 | fill=mean                          |
| R_all_aggressive   | softimpute      | 0.7370 |   0.209 | rank=10 (swept 1..10)              |
| S_all_standard     | fill-zeros           | 0.8926 |   0.180 | fill=zero                          |
| S_all_standard     | fill-mean       | 0.8923 |   0.179 | fill=mean                          |
| S_all_aggressive   | onesidedmc      | 0.9311 |   0.160 | r=2 (swept 1..10)                  |
| C_all_aggressive   | knn             | 0.9253 |   0.085 | k=6 (swept 1..10)                  |
| S_all_aggressive   | softimpute_corr | 1.0514 |   0.076 | rank=1                             |
| raw_all_aggressive | softimpute_corr | 1.1797 |   0.075 | rank=3 (swept 1..3)                |
| S_all_aggressive   | knn             | 1.0841 |   0.069 | k=4 (swept 1..10)                  |
| R_all_standard     | softimpute_corr | 1.2346 |   0.047 | rank=5 (swept 1..10)               |
| raw_all_standard   | onesidedmc      | 1.1045 |   0.044 | r=2 (swept 1..10)                  |
| S_all_aggressive   | missforest      | 1.0635 |   0.041 | ntree=100 (swept [50,100,200,400]) |
| R_all_standard     | missforest      | 1.2253 |   0.036 | ntree=200 (swept [50,100,200,400]) |
| R_all_standard     | onesidedmc      | 1.3507 |   0.035 | r=2 (swept 1..10)                  |
| raw_all_aggressive | missforest      | 1.2200 |   0.026 | ntree=400 (swept [50,100,200,400]) |
| raw_all_aggressive | knn             | 1.2247 |   0.021 | k=3 (swept 1..10)                  |
| R_all_aggressive   | softimpute_corr | 1.3517 |   0.019 | rank=1                             |
| raw_all_standard   | softimpute_corr | 1.2551 |   0.015 | rank=2 (swept 1..10)               |
| raw_all_aggressive | onesidedmc      | 1.5050 |   0.015 | r=2 (swept 1..10)                  |
| raw_all_standard   | missforest      | 1.2441 |   0.015 | ntree=200 (swept [50,100,200,400]) |
| R_all_aggressive   | knn             | 1.4189 |   0.013 | k=2 (swept 1..10)                  |
| R_all_standard     | knn             | 1.2854 |   0.011 | k=3 (swept 1..10)                  |
| R_all_aggressive   | onesidedmc      | 2.0522 |   0.007 | r=2 (swept 1..10)                  |
| R_all_aggressive   | missforest      | 1.3915 |   0.006 | ntree=200 (swept [50,100,200,400]) |
| raw_all_standard   | fill-mean       | 1.3404 |   0.000 | fill=mean                          |
| raw_all_standard   | knn             | 1.3065 |  -0.004 | k=5 (swept 1..10)                  |
| R_all_standard     | fill-mean       | 1.3990 |  -0.049 | fill=mean                          |
| S_all_aggressive   | fill-mean       | 1.2040 |  -0.087 | fill=mean                          |
| S_all_aggressive   | fill-zeros           | 1.2298 |  -0.139 | fill=zero                          |
| R_all_standard     | usvt            | 2.5911 |  -1.635 | eta=0.01                           |
| S_all_standard     | usvt            | 1.7823 |  -2.965 | eta=0.01                           |
| raw_all_standard   | usvt            | 2.9244 |  -5.031 | eta=0.01                           |
| S_all_aggressive   | usvt            | 2.9488 | -12.278 | eta=0.01                           |
