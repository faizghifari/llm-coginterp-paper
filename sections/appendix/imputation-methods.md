...
| ------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------ | ------------------------------------------------------------------------------------ |
| One-sided matrix completion \citep{cao2023} | Recovers the right-singular vectors of a reduced matrix of a large, super-sparse dataset. Originally demonstrated to work with simply 2 observations per row.                              | Custom implementation in Julia | Sweeps  rank 1...10, selecting the rank with the best $R^2$.                         |
