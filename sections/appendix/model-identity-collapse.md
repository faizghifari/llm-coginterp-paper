...
Benchmarks observed for only one collapse key are dropped, then collapse keys with no remaining benchmarks are dropped. This yields the two raw matrices of Table 2 in the Methodology, 1,266 × 404 at 2.2 % and 334 × 380 at 3.5 %, from 2,183 distinct source-level model identifiers.
...
cross-reference. Methodology Table 2 has no LaTeX label to point at yet. -->
