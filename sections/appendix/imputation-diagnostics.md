...
| C_all_standard     | zeros-fill           | 0.8910 |   0.286 | fill=zero                          |
...
| C_all_standard     | mean-fill       | 0.9268 |   0.224 | fill=mean                          |
| R_all_aggressive   | softimpute      | 0.7370 |   0.209 | rank=10 (swept 1..10)              |
| S_all_standard     | zeros-fill           | 0.8926 |   0.180 | fill=zero                          |
| S_all_standard     | mean-fill       | 0.8923 |   0.179 | fill=mean                          |
...
| raw_all_standard   | mean-fill       | 1.3404 |   0.000 | fill=mean                          |
| raw_all_standard   | knn             | 1.3065 |  -0.004 | k=5 (swept 1..10)                  |
| R_all_standard     | mean-fill       | 1.3990 |  -0.049 | fill=mean                          |
| S_all_aggressive   | mean-fill       | 1.2040 |  -0.087 | fill=mean                          |
| S_all_aggressive   | zeros-fill           | 1.2298 |  -0.139 | fill=zero                          |
