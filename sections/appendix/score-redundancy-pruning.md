...
| GPQA variants (few/zero-shot × diamond/main, Kaggle) | mean $r = 0.944$, worst pair $0.915$, over 46–47 shared models; better-populated canonical GPQA and GPQA Diamond already present | Drop all 4 Kaggle variants | 185 |
