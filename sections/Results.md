...
![[S_softimpute_tall.png| UMAP plot of benchmark distances from S, softimpute. Domain-similar benchmarks are not guaranteed to cluster together.]]

<!-- 2026-09-24: Figure 1 redrawn from viewer/positions.json at a taller aspect (scripts/plot_umap_figure.py in the analysis repo) to fill page 9. The viewer screenshot embed was: ![[S_softimpute.png| UMAP plot of benchmark distances from S, softimpute. Domain-similar benchmarks are not guaranteed to cluster together.]] -->
