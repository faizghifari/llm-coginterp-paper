...
At best, a general latent factor accounts for 74.7% of variance in model performance, but most of our solutions put it well below that. Domain-similar benchmarks are only occasionally located close together in vector space, and benchmarks with high $g$-loading do not share a common theme and differ from the benchmarks the field treats as standard measures of intelligence.
