...
\usepackage{caption}   % \caption* (unnumbered): appendix longtables get a real,
                        % table-attached caption without colliding with the
                        % manually-numbered Table 1-4 captions in the main text
\usepackage{amsmath}
